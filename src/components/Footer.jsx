    ...
    <footer className="text-gray-400 bg-gray-900 body-font">
      <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
          ...
          Unleash your creativity at our exciting hackathon event.
          </p>
        </div>
        <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              ...
              <li>
                <a className="text-gray-400 hover:text-white">Directions</a>
              </li>
              <li>
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              ...
              <li>
                <a className="text-gray-400 hover:text-white">Ideas</a>
              </li>
              <li>
                <a className="text-gray-400 hover:text-white">Media</a>
              </li>
            </nav>
          </div>
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              ...
              <li>
                <a className="text-gray-400 hover:text-white">Solutions</a>
              </li>
              <li>
                <a className="text-gray-400 hover:text-white">Study Materials</a>
              </li>
            </nav>
          </div>
        </div>
